...
public class UsuarioController {
    ...
    @PostMapping("/{id}/foto")
    public ResponseEntity<Void> uploadProfilePicture(@PathVariable Long id, @RequestParam("file") MultipartFile file) throws IOException, NotFoundException, java.io.IOException {
        usuarioService.uploadProfilePicture(file, id);
        return ResponseEntity.noContent().build();
    }
